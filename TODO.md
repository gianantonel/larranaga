...
- [x] **R-01 + R-02** Corrección tipo B/C + división alícuotas — herramientas.py + Herramientas.jsx
- [x] **R-05** Separación retenciones IVA vs IIBB — retenciones.py + Retenciones.jsx
- [x] **R-07** Cuentas corrientes — cuentas_corrientes.py + CuentasCorrientes.jsx
- [x] **R-03 + R-04** Cálculo honorarios + Liquidación profesionales — honorarios.py + profesionales.py (commit 48e5e6e, 2026-04-27)
